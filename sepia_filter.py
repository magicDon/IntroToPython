...
Purpose: To filter a picture to a sepia color, this program will be implemented with other programs.
It will not run unless you download the image I have imported. """
